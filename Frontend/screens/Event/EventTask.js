                                ...
                                { (item.Candidate) ? (
                                    <View style={styles.user}>
                                        ...
                                        <View style={{
                                            ...
                                            <Text style={styles.text}><Text style={{fontWeight: '600'}}>Nom:</Text> {item.Candidate.User.name}</Text>
                                            <Text style={styles.text}><Text style={{fontWeight: '600'}}>Email:</Text> {item.Candidate.User.gmail}</Text>
                                            <Text style={styles.text}><Text style={{fontWeight: '600'}}>Télephone:</Text> {item.Candidate.User.telephone}</Text>
                                        </View>
                                    </View>
                                ) : (
                                    <></>
