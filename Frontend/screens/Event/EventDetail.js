            ...
            <View style={styles.contentContainer}>
                ...
                <View style={styles.item}>
                    <View style={styles.leader}>
                        ...
                        <View>
                            <Text style={styles.textInfor}><Text style={styles.subTitle}>Nom: </Text>{leader.name}</Text>
                            <Text style={styles.textInfor}><Text style={styles.subTitle}>Email: </Text>{leader.gmail}</Text>
                            <Text style={styles.textInfor}><Text style={styles.subTitle}>Télephone: </Text>{leader.telephone}</Text>
                            <Text style={styles.textInfor}><Text style={styles.subTitle}>Université: </Text>{leader.university}</Text>
                        </View>
                    </View>
                </View>
