...
export default function UpdateProfile() {
    ...
    const handleSave = () => {
        ...
        if(name == '')
        {
            setErrName("S'il vous plaît entrez votre nom")
            return
        }
        else
        setErrName('')
        ...
        if(telephone == '')
        {
            setErrPhone('Veuillez entrer votre téléphone')
            return
        }
        else
        setErrPhone('')
        ...
        {
            setErrPhone('Veuillez entrer les 10 chiffres')
            return
        }
        else
        setErrPhone('')
        ...
        if(birthday == '')
        {
            setErrBirthday('Veuillez entrer votre date de naissance')
            return
        }
        else
        setErrBirthday('')
        ...
        if(address == '')
        {
            setErrAddress('Veuillez entrer votre adresse')
            return
        }
        else
        setErrAddress('')
        ...
        if(gender == '')
        {
            setErrGender('Veuillez choisir votre sexe')
            return
        }
        setErrGender('')
        // faculity_name
        if(faculity_name == '')
        {
            setErrFaculityName('Veuillez choisir le nom de votre visage')
            return
        }
        setErrFaculityName('')
    ...
    const requesCameraPerission = async () => {
        try {
            ...
            if (status === "granted") {
                ...
                alert(
                    "Autorisation de la caméra refusée. Veuillez activer l'accès à la caméra dans les paramètres de votre appareil."
                );
            }
        } catch (error) {
            console.log(error);
                            ...
                            <RNPickerSelect
                                onValueChange={(value) => {
                                    setErrGender(
                                        isValidSelect(value)
                                            ? ""
                                            : "Ce champ doit être sélectionné"
                                    );
                                    setGender(value);
                                }}
                                items={genderOption}
                            ...
                            onChangeText={(text) => {
                                setErrAddress(
                                    isValidLength(text, 6) == true
                                        ? ""
                                        : "L'adresse n'est pas au bon format"
                                );
                                setAddress(text);
                            }}
                        />
                        ...
                        <RNPickerSelect
                            onValueChange={(value) => {
                                setErrFaculityName(
                                    value
                                        ? ""
                                        : "Faculté pas dans le bon format"
                                );
