        ...
        <View style={styles.container}>
            <View style={styles.form}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.subText}>Entrez un nouveau mot de passe ci-dessous pour changer votre mot de passe</Text>
                </View>
                ...
                <View style={styles.bottom}>
                    ...
                    >
                        <Text style={styles.textBtn}>Sauvegarder les modifications</Text>
                    </TouchableOpacity>
