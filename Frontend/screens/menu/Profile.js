        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.infor}>
                    <Text style={{fontSize: 14, fontWeight: '600', marginTop: 16}}>02 <Text style={{fontWeight: '400'}}>Participer</Text> </Text>
                    <Text style={{fontSize: 14, fontWeight: '600', marginTop: 16}}>12 <Text style={{fontWeight: '400'}}>Événements</Text></Text>
                </View>
            </ImageBackground>
            ...
            />
                ...
                <View style={{width : "100%", justifyContent : "center", alignItems : "center"}}>
                    <Text style={styles.noEvent}>Ne participe actuellement à aucun événement</Text>
                </View>
            )
            }
            </View>
